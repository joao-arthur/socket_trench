...
public final class MatchPanel extends JPanel implements Observer<String> {
    ...
    protected final void paintComponent(Graphics g) {
        ...
        drawer.drawImage(background.texture, background.sprite.x, background.sprite.y, null);
        drawer.drawImage(player1.texture, player1.sprite.x, player1.sprite.y, null);
        drawer.drawImage(player2.texture, player2.sprite.x, player2.sprite.y, null);
        for (var shoot : player1Shoots) {
            drawer.drawImage(shoot.texture, shoot.sprite.x, shoot.sprite.y, null);
        }
